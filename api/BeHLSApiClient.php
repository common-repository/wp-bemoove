...
class BeHLSApiClient {
    ...
    static function addAcount($username,$comname,$usermail,$usertel) {
        ...
        if (!empty($adminApiPrekey)) {
            ...
            $response = file_get_contents("{$apiRootUri}/account/add.php?domain=".$bm_domain."&n=".urlencode($username)."&c=".urlencode($comname)."&m=".urlencode($usermail)."&t=".urlencode($usertel)."", true, $context);
