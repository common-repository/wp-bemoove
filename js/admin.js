jQuery(document).ready(function() {
    ...
    // メッセージ   -   Message
    var fade_msg_box = jQuery('.fade_msg_box');
    ...
    var file_upload_spec_list = jQuery('#file_upload_spec_list');
    ...
    var movie_listitem_wrap = jQuery('div.movie_listitem_wrap');
    if (movie_listitem_wrap && 0 < movie_listitem_wrap.length) {
        ...
        jQuery(document).on('click', 'div.movie_listitem_wrap .copy', function(){
            jQuery(this).select();
        });
